...
void main() {
  group('UserSession Data Model TDD Tests', () {
    ...
    test('Should correctly parse valid JSON payload into authenticated UserSession model', () {
      ...
      expect(session.jwtToken, equals('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.mockTokenSignature'));
      expect(session.isAuthenticated, isTrue);
    });

    test('Should successfully enforce structural fallback parameters for Anonymous Guest accounts', () {
